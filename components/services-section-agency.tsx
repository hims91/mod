...
import { Globe, Search, ShoppingCart, TrendingUp, Bot, Settings, ArrowRight } from "lucide-react"
...
const services = [
  ...
  },
  {
    ...
    subtitle: "We Maintain. You Focus on Business",
    description: "We manage your site updates, backups, bugs, and performance so you don't have to worry.",
    features: [
    ...
    size: "small",
    clickable: true,
    chatMessage: "I need website maintenance services. What maintenance packages do you offer?",
  },
]
                ...
                <div className="glass rounded-2xl md:rounded-3xl p-4 md:p-6 lg:p-8 border border-white/10 hover:border-primary/40 hover:shadow-lg hover:shadow-primary/20 transition-all duration-500 relative overflow-hidden h-full flex flex-col justify-between">
                  ...
                  <div className="relative z-10 flex flex-col h-full">
                    ...
                    <div className="mb-3 md:mb-4">
                      <div
                        className={`w-12 h-12 md:w-16 md:h-16 rounded-xl md:rounded-2xl bg-gradient-to-br ${service.color.replace("/20", "/30")} p-3 md:p-4 flex items-center justify-center group-hover:scale-110 group-hover:rotate-6 transition-all duration-500 border border-white/10`}
                      >
